            ...
            <div class="col-lg-6 col-md-12 order-sm-1">
                <div class="d-flex flex-column align-items-center card shadow py-5 px-5 mx-auto">
                    ...
                    <form action="" method="post" class="form">
                        <div class="mb-4">
                            <input type="username" class="form-control px-4 py-3" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Username" name="username" />
                        </div>
                        <div class="mb-4">
                            <input type="password" class="form-control px-4 py-3" id="exampleInputPassword1" placeholder="Password" name="password" />
                        </div>
                        <div class="mb-4">
                            <input type="password" class="form-control px-4 py-3" id="exampleInputPassword1" placeholder="Confirm Password" name="confirm-password" />
                        </div>
                        <div class="mb-4">
                            <input type="email" class="form-control px-4 py-3" id="exampleInputPassword1" placeholder="Your Email Address" name="email" />
                        </div>
                        <div class="d-grid mb-5">
                            <button type="submit" class="btn py-3 fw-bold btn-primary border border-none bgAcsent" name="register">Register</button>
                        </div>
                        <p class="text-center">
