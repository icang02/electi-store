            ...
            <div class="col-lg-6 col-md-12">
                <div class="card d-flex flex-column align-items-center shadow py-5 px-5 mx-auto">
                    ...
                    <form action="" method="post">
                        <div class="mb-4">
                            <input type="username" class="form-control px-4 py-3" placeholder="Username" name="username"
                                required />
                        </div>
                        <div class="mb-4">
                            <input type="password" class="form-control px-4 py-3" placeholder="Password" name="password"
                                required />
                        </div>
